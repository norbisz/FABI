...
void keyboardBTPress(int key) {
  ...
  // if (activeKeyCodes[0] != key && activeKeyCodes[1] != key && activeKeyCodes[2] != key && activeKeyCodes[3] != key && activeKeyCodes[4] != key && activeKeyCodes[5] != key) {
...
void performAddonUpgrade() {
  ...
  //         break;
  //       case 1:
  //         if (inByte == 'F') readstate_f++;
  //         else readstate_f = 0;
  //         break;
  //       case 2:
  //         if (inByte == 'I') readstate_f++;
  //         else readstate_f = 0;
  //         break;
  //       case 3:
  //         if (inByte == 'N') {
